#!/usr/bin/env python 
# -*- coding: utf-8 -*- 
# @Time : 2019-10-23 10:30 
# @Author : Aries 
# @Site :  
# @File : extract_feature.py 
# @Software: PyCharm
from bert_service import modeling
from bert_service import tokenization
from bert_service.graph import optimize_graph
from bert_service import args
...
if __name__ == "__main__":
    ...
    vectors = bert.encode(['北京到上海的机票', '上海到北京的机票'])
    print(np.squeeze(vectors).shape)
